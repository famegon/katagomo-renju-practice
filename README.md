...
| 커밋 | 내용 |
|---|---|
| `8afe564` | Stage 1 엔진·모델·실분석 검증 |
| `0be3449` | Stage 2 persistent 분석 서버 |
| `d0707e2` | 반복 연습 UI와 채점 |
| `2acbb4c` | 실행 재현성 검증 |
| `0a1ed08` | 데스크톱 Renju 연습 플랫폼 |
| `54952ae` | 실제 엔진 기반 수 비교 실험실 |
| `f66d0ea` | 데스크톱 분석 작업대 단순화 |
| `bf82781` | 재연결 뒤 AI 자동 응수 복구 |
| `76f7961` | 공개용 온보딩·문서·배포 가드 |
